                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <select class="form-control" name="recaptcha:enabled">
                                        <option value="true" @if(filter_var(old('recaptcha:enabled', config('recaptcha.enabled')), FILTER_VALIDATE_BOOLEAN)) selected @endif>Enabled</option>
                                        <option value="false" @if(!filter_var(old('recaptcha:enabled', config('recaptcha.enabled')), FILTER_VALIDATE_BOOLEAN)) selected @endif>Disabled</option>
                                    </select>
