...
@section('content')
    <form action="{{ route('admin.arix.social') }}" method="POST" class="content-box">
        ...
        >
            ...
            />
            <div id="dropdown-socials" class="{{ filter_var($socialButtons, FILTER_VALIDATE_BOOLEAN) ? 'open' : '' }}">
        ...
        function addSocialItem() {
            ...
            newItem.innerHTML = `
                <div class="row">
                    ...
                    <div class="col-md-6 input-field">
                        <label>Icon Name</label>
                        <select name="arix:socials[${newIndex}][icon]">
                            <option value="">Select an icon</option>
            ...
            items.forEach((item, index) => {
                ...
                fields.forEach(field => {
                    ...
                    if (name) {
                        ...
                        if (match) {
                            field.setAttribute('name', `arix:socials[${index}][${match[1]}]`);
                        }
                    }
                });
            });
